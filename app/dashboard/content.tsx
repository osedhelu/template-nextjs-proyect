...
export const HomePageContent: NextPage = function () {
  return (
    <div className="p-6">
      ...
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Accordion</h2>
        </header>
        <AccordionExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Avatar</h2>
        </header>
        <AvatarExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Badges</h2>
        </header>
        <BadgesExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Breadcrumb</h2>
        </header>
        <BreadcrumbExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Buttons</h2>
        </header>
        <ButtonsExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Button group</h2>
        </header>
        <ButtonGroupExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Card</h2>
        </header>
        <CardExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Carousel</h2>
        </header>
        <CarouselExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Dropdown</h2>
        </header>
        <DropdownExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Forms</h2>
        </header>
        <FormsExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Footer</h2>
        </header>
        <FooterExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">List group</h2>
        </header>
        <ListGroupExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Modal</h2>
        </header>
        <ModalExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Navbars</h2>
        </header>
        <NavbarsExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Pagination</h2>
        </header>
        <PaginationExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Progress</h2>
        </header>
        <ProgressExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Rating</h2>
        </header>
        <RatingExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Sidebar</h2>
        </header>
        <SidebarExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Spinners</h2>
        </header>
        <SpinnersExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Tables</h2>
        </header>
      ...
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Tabs</h2>
        </header>
        <TabsExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Timeline</h2>
        </header>
        <TimelineExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Toast</h2>
        </header>
        <ToastExample />
      </section>
      <section>
        <header>
          <h2 className="mb-3 mt-9 text-4xl font-bold dark:text-gray-200">Tooltips</h2>
        </header>
        <TooltipsExample />
      </section>
    </div>
...
const CardExample: FC = function () {
  return (
    <div className="max-w-sm">
      <Card imgAlt="Meaningful alt text for an image that is not purely decorative" imgSrc="/image-1.jpg">
    ...
    <Footer container>
      <div className="w-full">
        <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
          <div>
            <Footer.Brand href="https://flowbite.com" src="/favicon.png" alt="Flowbite Logo" name="Flowbite" />
          </div>
  ...
  return (
    <Navbar fluid rounded>
      <Navbar.Brand href="https://flowbite.com/">
        ...
        <span className="self-center whitespace-nowrap pl-3 text-xl font-semibold dark:text-white">Flowbite</span>
      </Navbar.Brand>
      <div className="flex md:order-2">
        <Dropdown inline label={<Avatar alt="User settings" img="/profile-picture-5.jpg" rounded />}>
          <Dropdown.Header>
...
const ProgressExample: FC = function () {
  return <Progress labelProgress progress={45} textLabel="Flowbite" textLabelPosition="outside" />
}
